...
execute at @e[type=minecart,tag=delay_bell_n3] run playsound minecraft:block.note_block.bell block @a ~ ~ ~ 1 0.841
execute at @e[type=minecart,tag=delay_bell_n1] run playsound minecraft:block.note_block.bell block @a ~ ~ ~ 1 0.667
# SFX destructor
