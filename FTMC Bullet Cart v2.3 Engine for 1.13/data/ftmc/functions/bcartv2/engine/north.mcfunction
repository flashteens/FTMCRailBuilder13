data merge entity @s[tag=!ftbc_is_v22_enabled] {Motion:[0d,0d,-1d]}
data merge entity @s[tag=!ftbc_is_v22_enabled,scores={bulletcartew=1..}] {Motion:[1d,0d,-1d]}
data merge entity @s[tag=!ftbc_is_v22_enabled,scores={bulletcartew=..-1}] {Motion:[-1d,0d,-1d]}
...
execute if score @s ftbc_recur_count matches 0 run scoreboard players operation @s ftbc_recur_tpdmz -= @s ftbc_recur_tpspd
execute if score @s ftbc_recur_count matches 1.. run scoreboard players remove @s ftbc_recur_tpdz 1
