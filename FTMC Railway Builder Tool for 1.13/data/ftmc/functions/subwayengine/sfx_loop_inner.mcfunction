...
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=49}] remove delay_bell_n3
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=44}] add delay_bell_n1
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=43}] remove delay_bell_n1
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=30}] add delay_bell_n3
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=29}] remove delay_bell_n3
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=24}] add delay_bell_n1
tag @s[type=minecart,tag=sfx_ftmc_se,scores={ftcarttimer=23}] remove delay_bell_n1
...
tag @s[type=minecart,tag=sfx_ftmc_se3,scores={ftcarttimer=49}] remove delay_bell_se3
