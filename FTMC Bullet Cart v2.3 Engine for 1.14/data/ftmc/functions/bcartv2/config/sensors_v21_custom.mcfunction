...
# test
execute if entity @s[scores={BCartConfigID=100}] if block ~ ~-1 ~ diorite run playsound block.note_block.bit block flashteens ~ ~ ~ 1 1.0
execute if entity @s[scores={BCartConfigID=101}] if block ~ ~-1 ~ diorite run playsound block.note_block.bit block flashteens ~ ~ ~ 1 2.0
execute if entity @s[scores={BCartConfigID=99}] if block ~ ~-1 ~ diorite run playsound block.note_block.bit block flashteens ~ ~ ~ 1 0.5
